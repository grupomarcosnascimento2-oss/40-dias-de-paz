    ...
    <AppShell>
      <div className="min-h-screen">
        ...
        <TabsPrimitive.Root defaultValue="caminhada" className="mt-6">
          <TabsPrimitive.List className="mx-auto flex max-w-3xl gap-1.5 px-6">
            <TabsPrimitive.Trigger
              value="caminhada"
              className="flex-1 rounded-full px-4 py-2.5 text-sm font-medium text-muted-foreground transition-all data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-[0_8px_18px_-10px_color-mix(in_oklab,var(--navy)_60%,transparent)]"
            >
              Sua caminhada
            </TabsPrimitive.Trigger>
            <TabsPrimitive.Trigger
