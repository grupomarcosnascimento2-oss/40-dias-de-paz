...
-- (administrador, pagante ou visitante). Criada como parte do controle
...
CREATE TABLE public.perfis (
  ...
  papel TEXT NOT NULL DEFAULT 'visitante' CHECK (papel IN ('administrador', 'pagante', 'visitante')),
...
-- mínimo). Promover alguém a "pagante" ou "administrador" exige o
